...
class LeitorOpcoesCLI {
    ...
    private CommandLine parseDosArgumentos(Options options, String[] args) throws ParseException {
    ...
    private void trataFormato(CommandLine cmd) {
        ...
        System.out.println(nomeDoFormatoDoEbook);
    ...
    private void trataArquivoDeSaida(CommandLine cmd) throws Exception {
